    ...
    return (
        <>
            ...
            {/* <div id="contact" className="flex py-20 flex-col gap-2 items-center justify-center">
                ...
                <h2 className="text-xl  text-center leading-tight"><span className="opacity-60">Want to chat? Just shoot me a dm with</span> <a href="https://instagram.com/waleeddotdev" className="text-[#ffffff] opacity-90 hover:opacity-60 duration-75 transition-all underline">a direct question on Instagram</a> <span className="opacity-60">and I'll respond whenever I can. I will ignore all soliciting.</span>
                </h2>
            </div> */}
            <Cta/>
        </>
